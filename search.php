...
<div id="pageContainer" class="contentPage">
    <?php include "testHead.php" ?>
    <main>
        Doing it like this for now. Just want the basic funtionality first.
        <form action="">
            <input type="text" name="userSearch" placeholder="user search"> <input type="submit">
        </form>
        <form action="">
            <input type="text" name="postSearch" placeholder="post search"> <input type="submit">
        </form>
        <section>
